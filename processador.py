# SECOM Tools/ME-EPP/processador.py
# -*- coding: utf-8 -*-
"""
...
# COL_FLAG_COTA_UI foi removido, a informação virá como parâmetro
...
def processar_df_orcamento(df: pd.DataFrame, original_had_qtd_total: bool, indices_marcados: Set[int]) -> pd.DataFrame:
    ...
    for index, row in df.iterrows():
        ...
        if index in indices_marcados: # Verifica se o índice da linha está no conjunto de marcados
    ...
    # Recalcula as colunas de quantidade e valor, incluindo a total
